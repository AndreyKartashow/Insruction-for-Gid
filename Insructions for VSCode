...
## Проверка работы git и VS Code 
Перед началом  работы с git и VS Code, необходимо выполнить следующие действия: 
...
## Активация учетной записи, создание файла в VS Code и репозитория в git 
...
## Работа с ветками
Ветки позволяют делить файл на разные подфайлы (подуровни), в которых можно решать отдельные задачи, а затем их переносить в отдельный  файл. Для того чтобы работать с ветками, необходимо знать такие команды, как:
